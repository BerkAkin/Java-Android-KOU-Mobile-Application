...
public class ogrenci_devam_eden_basvurular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirestoreRecyclerOptions<ogrenci_devam_eden_basvurulari_gormek> options = new FirestoreRecyclerOptions.Builder<ogrenci_devam_eden_basvurulari_gormek>()
                .setQuery(query, ogrenci_devam_eden_basvurulari_gormek.class)
                .build();
        adapter = new FirestoreRecyclerAdapter<ogrenci_devam_eden_basvurulari_gormek, ogrenci_devam_eden_basvurular.viewHolder>(options) {


            @NonNull
            @Override
            //VERÝ GÖRÜNTÜMÜZ OLUÞURKEN ÝÇERÝKLERÝN AGÖRÜNTÜLENMESÝ ÝÇÝN
            public ogrenci_devam_eden_basvurular.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ogrenci_devam_eden_basvurular_tek_bilgi, parent, false);
                return new ogrenci_devam_eden_basvurular.viewHolder(view);
            }


            //VÝEWHOLDER'I ALIP ÝÇÝNDEKÝ NESNELERÝ GÖRÜNTÜYE BAÐLAR
            @Override
            protected void onBindViewHolder(@NonNull ogrenci_devam_eden_basvurular.viewHolder holder, int position, @NonNull ogrenci_devam_eden_basvurulari_gormek model) {
    ...
    private class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            list_adres = itemView.findViewById(R.id.tw_ogrenci_tek_bilgi_basvuru_ismi);
            list_tc = itemView.findViewById(R.id.tw_ogrenci_tek_bilgi_basvuru_tarihi);
            list_mail = itemView.findViewById(R.id.tw_ogrenci_tek_bilgi_basvuru_durumu);
